classdef kite
 ...
 %--------------------------------------------------------------------------------------------%      
        ...
        % Original parametrization of the curve between 0:2*pi
            ...
            %kite
            x  = obj.loc + obj.rad*[cos(t)+0.65*cos(2*t)-0.65 1.5*sin(t)];
            dx = obj.rad*[-sin(t)-1.3*sin(2*t) 1.5*cos(t)];
            d2x = obj.rad*[-cos(t)-2.6*cos(2*t) -1.5*sin(t)];
            d3x = obj.rad*[sin(t)+5.2*sin(2*t) -1.5*cos(t)];
